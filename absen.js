...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Enter pada form login
    const loginNip = document.getElementById('loginNip');
    const loginPassword = document.getElementById('loginPassword');
    if (loginNip) {
        loginNip.addEventListener('keypress', function (e) {
            if (e.key === 'Enter') {
                e.preventDefault();
    ...
    const selectKelas = document.getElementById('selectKelas');
    if (selectKelas) {
        selectKelas.addEventListener('change', onKelasChange);
    }

    // Input tanggal
    const selectTanggal = document.getElementById('selectTanggal');
    if (selectTanggal) {
        selectTanggal.addEventListener('change', onTanggalChange);
    }

    // Tombol kirim
    const btnKirim = document.getElementById('btnKirim');
    if (btnKirim) {
        btnKirim.addEventListener('click', submitAttendance);
    }
